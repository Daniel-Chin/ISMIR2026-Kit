...
def registration_stats(in_csv):
    ...
    morntut_choice_ind = words.index(
        "Select the morning session tutorial you wish to attend"
    )
    noontut_choice_ind = words.index(
    ...
    print(
        "Total registered: {} [{}: full, {}: student]".format(
    ...
    print(
        "Total physical: {} [{}: full, {}: student]".format(
    ...
    print(
        "Total virtual: {} [{}: full, {}: student]".format(
    ...
    print(
        "Total undecided: {} [{}: full, {}: student]".format(
    ...
    for tut_ind in tut_counters:
        ...
        print(
            "\tTotal registered {}: \n\tFull - {}, Student - {}".format(
                tut_counters[tut_ind]["Full"]["In-person"]
                + tut_counters[tut_ind]["Student"]["In-person"]
                + tut_counters[tut_ind]["Full"]["Virtually"]
                + tut_counters[tut_ind]["Student"]["Virtually"]
                + tut_counters[tut_ind]["Full"]["Undecided"]
                + tut_counters[tut_ind]["Student"]["Undecided"],
                tut_counters[tut_ind]["Full"]["In-person"]
                + tut_counters[tut_ind]["Full"]["Virtually"]
                + tut_counters[tut_ind]["Full"]["Undecided"],
                tut_counters[tut_ind]["Student"]["In-person"]
        ...
        print(
            "\tPhysical - {}, Virtual - {}, Undecided - {}".format(
                tut_counters[tut_ind]["Full"]["In-person"]
                + tut_counters[tut_ind]["Student"]["In-person"],
                tut_counters[tut_ind]["Full"]["Virtually"]
                + tut_counters[tut_ind]["Student"]["Virtually"],
